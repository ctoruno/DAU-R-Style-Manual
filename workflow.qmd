...
For an example on one of these files, please check the [following README file](https://github.com/ctoruno/WJP-Resources/blob/main/README_template.md). If possible, use this example as a template for future projects.
