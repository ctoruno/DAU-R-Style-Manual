![Zacatal by nicaraguan painter Raúl Marín](www/cover.jpeg){fig-alt="Zacatal by nicaraguan painter Raúl Marín" fig-align="center"}
...
-   An intermediate knowledge of [R Programming Language](https://www.r-project.org/about.html).
...
This website is free to use and it is licensed under the [Creative Commons Attribution-NonCommercial-NoDerivs 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/) License. Physical copies of this handbook are not currently available. If you are not a member of the DAU team, feel free to report typos, request information or even contribute by commenting or leaving a pull request at [ctoruno/DAU-R-Style-Manual](https://github.com/ctoruno/DAU-R-Style-Manual). This handbook was created using [Quarto Publishing System](https://quarto.org/).
